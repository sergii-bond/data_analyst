...
def ttest(turnstile_weather):
    ...
    t, p = scipy.stats.ttest_ind(with_rain, without_rain, equal_var = False)
    
    return with_rain_mean, without_rain_mean, t, p # leave this line for the grader

if __name__ == '__main__':
    turnstile_weather = pd.read_csv("turnstile_data_master_with_weather.csv")
    print ttest(turnstile_weather)
